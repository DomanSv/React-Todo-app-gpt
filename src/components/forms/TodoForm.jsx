        ...
        />
          ...
          <div className='pt-1'>
            ...
            <textarea
              ...
              className='block min-h-[7rem] w-full rounded-md border-gray-300 transition-shadow focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-slate-500 dark:text-white dark:ring-offset-slate-900 dark:placeholder:text-slate-200 dark:focus:bg-slate-600'
              {...register("description")}
            ></textarea>
        ...
        {fields.map((field, index) => (
          <div className='flex flex-col' key={field.id}>
            ...
            <div className='flex w-full'>
              ...
              <button
                type='button'
                className='ml-2 rounded-md bg-red-500 pl-3 pr-3 text-lg text-white'
                onClick={() => {
                  remove(index);
                }}
              >
